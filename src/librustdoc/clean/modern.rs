...
use super::{clean_middle_region, clean_middle_term, clean_middle_ty};
use super::{clean_poly_trait_ref_with_constraints, projection_to_path_segment};
use super::{AssocItemConstraint, AssocItemConstraintKind, GenericBound, WherePredicate};
...
fn is_instance_of<'tcx>(
    ...
    // FIXME: these are not the elaborated ones, can you find an example where this
    // matters?
