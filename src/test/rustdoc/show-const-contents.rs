...
// @has show_const_contents/constant.CONST_I32_HEX.html '= 66;'
...
// @has show_const_contents/constant.CONST_EQ_TO_VALUE_I32.html '= 42;'
// @!has show_const_contents/constant.CONST_EQ_TO_VALUE_I32.html '; //'
pub const CONST_EQ_TO_VALUE_I32: i32 = 42i32;

// @has show_const_contents/constant.CONST_CALC_I32.html '= 43;'
// @!has show_const_contents/constant.CONST_CALC_I32.html '; //'
...
// @has show_const_contents/constant.CONST_I32_MAX.html '= i32::MAX;'
// @!has show_const_contents/constant.CONST_REF_I32.html '; //'
...
// @has show_const_contents/constant.PI.html '= 3.14159274;'
// @!has show_const_contents/constant.PI.html '; //'
pub use std::f32::consts::PI;

// FIXME: This is also quite sad (concrete value not shown anymore).
// @has show_const_contents/constant.MAX.html '= i32::MAX;'
// @!has show_const_contents/constant.PI.html '; //'
...
// @has show_const_contents/constant.MIN.html '= i16::MIN;'
// @!has show_const_contents/constant.MIN.html '; //'
int_module!(i16);
