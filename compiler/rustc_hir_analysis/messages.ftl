...
hir_analysis_unused_generic_parameter =
    ...
    .const_param_help = if you intended `{$param_name}` to be a const parameter, use `const {$param_name}: usize` instead
...
hir_analysis_unused_generic_parameter_adt_without_phantom_data_help =
