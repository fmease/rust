use crate::astconv::{HirLowerer, OnlySelfBounds, PredicateFilter};
    ...
    for param in ast_generics.params {
        match param.kind {
            ...
            GenericParamKind::Type { .. } => {
                let param_ty = icx.lowerer().hir_id_to_bound_ty(param.hir_id);
            ...
            hir::GenericParamKind::Const { .. } => {
                ...
                let ct = icx.lowerer().hir_id_to_bound_const(param.hir_id, ct_ty);
                predicates.insert((
